...
export const useTaskStore = defineStore('tasks', () => {
  ...
  // - Push a new task: { id: nextId.value++, name, done: false, dueDate:  }
  function addTask(name) {
    // your code here
    if (!name.trim()) return

    tasks.value.push({ id: nextId.value++, name, done: false, dueDate: Date().toLocaleString() })
  ...
  return { tasks, totalCount, doneCount, pendingCount, addTask, toggleTask, removeTask, getTaskById }
})
